  ...
  return (
    <div className={`flex items-center ${className}`}>
      <div className="relative w-10 h-10">
        ...
        <div className="absolute top-4 right-2 w-0.5 h-0.5 bg-green-300 rounded-full animate-ping" style={{ animationDelay: '0.3s' }}></div>
        <div className="absolute bottom-2 left-4 w-0.5 h-0.5 bg-purple-300 rounded-full animate-ping" style={{ animationDelay: '0.7s' }}></div>
      </div>
    </div>
  );
}
