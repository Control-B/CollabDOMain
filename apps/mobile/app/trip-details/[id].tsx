...
// Mock trip data (same as in trip-sheets.tsx)
const mockTrips = [
  {
    id: '1',
  ...
  },
  {
    ...
    pickupAddress: '789 Pine St, Queens, NY 11375',
    pickupPhone: '+1 (555) 555-6666',
    pickupNumber: 'PO-2024-002',
    deliveryLocation: 'Store C',
    deliveryAddress: '321 Elm Dr, Staten Island, NY 10301',
    deliveryPhone: '+1 (555) 777-8888',
    appointmentTime: '2024-08-31 10:00',
    loadDetails: 'Furniture - 20 items (Chairs, Tables, Cabinets)',
    specialInstructions: 'Assembly required. Coordinate with store manager.',
    createdAt: '2024-08-31 06:00',
    timeline: [
      { time: '06:00', status: 'created', description: 'Trip sheet created' },
      { time: '06:30', status: 'dispatched', description: 'Driver dispatched' },
      { time: '07:00', status: 'en_route', description: 'En route to pickup' },
      {
        time: '08:30',
        status: 'arrived_pickup',
        description: 'Arrived at pickup location',
      },
      { time: '09:00', status: 'loading', description: 'Loading in progress' },
      {
        time: '10:00',
        status: 'departed_pickup',
        description: 'Departed pickup location',
      ...
      { time: '12:30', status: 'completed', description: 'Delivery completed' },
    ],
  },
];
...
export default function TripDetailsScreen() {
  ...
  const handleEditTrip = () => {
    Alert.alert(
      'Edit Trip',
      `Edit trip ${trip.tripNumber}\n\nThis will open the trip editing form.`
    );
  };
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          style: 'destructive',
          onPress: () => {
            Alert.alert('Trip Deleted', 'Trip has been deleted successfully.', [
  ...
  const handleStatusUpdate = () => {
    ...
    Alert.alert(
      ...
      statusOptions.map((status) => ({
        text: status,
        onPress: () => {
          Alert.alert('Status Updated', `Trip status updated to: ${status}`);
        },
      }))
    );
  };
